...
export const quest1: Lesson[] = [
  ...
  },
  {
    ...
    transcript: [
      {
        title: "Anleitung zum Video",
        text: "Willst du dich in der Welt von Ethereum ausprobieren, ohne echtes Geld zu riskieren? Dann ist das Sepolia Testnet genau das Richtige für dich. Hier erfährst du, wie du Test-ETH von Sepolia beantragen und für deine ersten Schritte in der Ethereum-Welt verwenden kannst."
      },
      {
        subline: '1. Sepolia Test-ETH beantragen',
        text: '1.1 Öffne zuerst deine Metamask Wallet-Extension, die du in deinem Browser installiert hast. Du findest sie in der oberen rechten Ecke deines Bildschirms. Klicke darauf und du siehst deine Wallet-Adresse. Kopiere diese Adresse.',
      },
      {
        text: '1.2 Jetzt besuche Alchemy - eine der bekanntesten Faucet-Websites für das Sepolia Testnet. Du musst dich zuerst einloggen, entweder mit Google oder per E-Mail.',
        links: [
          {
            linkText: "Alchemy",
            href: "https://sepoliafaucet.com/"
      ...
      {
        text: '1.3 Nachdem du eingeloggt bist, füge die kopierte Adresse in das entsprechende Feld ein und löse das CAPTCHA, um zu beweisen, dass du kein Roboter bist.'
      },
      {
        text: '1.4 Klicke auf "Test ETH senden". Wenn alles erfolgreich war, siehst du eine Benachrichtigung.'
      },
      {
        subline: 'Hinweis: Wenn du eine VPN aktiviert hast, könnten hierbei Probleme auftreten. Es kann hilfreich sein, diese vorübergehend zu deaktivieren.'
      },
      {
        subline: '2. Test-ETH verwenden',
        text: '2.1 Gehe zurück zu deiner Metamask Wallet und du solltest nun 0,5 Sepolia Test-ETH in deinem Account sehen. Mit diesen kannst du im Sepolia Testnet verschiedene Funktionen testen und experimentieren.',
      },
      {
        text: '2.2 Für jede abgeschlossene Challenge erhältst du eine Belohnung in Form eines sogenannten NFT (Non-Fungible Token), der mit dem Test-ETH bezahlt wird. Diesen NFT kannst du dann in deiner Wallet finden.',
      },
      {
        subline: 'Zusätzliche Informationen',
        text: 'Faucets: Faucets sind Websites, die kostenlose Kryptowährungen anbieten, um Nutzern das Testen und Experimentieren auf verschiedenen Blockchains zu ermöglichen. Es gibt verschiedene Anbieter, aber Alchemy ist eine der beliebtesten für das Sepolia Testnet.',
      },
      {
        text: 'Testnetze: Testnetze sind separate Blockchains mit ihrer eigenen Kryptowährung (im Falle von Sepolia ist das Test-ETH), die nur zum Testen verwendet wird. Sie ermöglichen es Nutzern und Entwicklern, neue Funktionen auszuprobieren und zu lernen, ohne echtes Geld zu riskieren.',
      },
      {
        text: 'NFTs: NFTs oder Non-Fungible Tokens sind einzigartige digitale Vermögenswerte, die auf der Blockchain gespeichert sind. Sie können alles von digitaler Kunst bis hin zu virtuellem Eigentum repräsentieren und sind ein spannender Teil des Ethereum-Ökosystems.',
      },
      {
        text: 'Viel Spaß beim Testen und Lernen im Sepolia Testnet! Vergiss nicht, du kannst alle 24 Stunden weitere 0,5 Test-ETH anfordern, wenn du mehr zum Experimentieren benötigst. Wenn du Fragen hast oder weitere Informationen benötigst, zögere nicht, uns zu kontaktieren. Wir sind hier, um zu helfen!',
      },
    ]
  },
  {
    ...
    transcript: [
      {
        title: "Anleitung zum Video",
        text: 'Im Zeitalter der Blockchain-Technologie und Kryptowährungen gibt es eine wachsende Anzahl von dezentralisierten Anwendungen, besser bekannt als DApps. Eine entscheidende Komponente der Interaktion mit diesen DApps ist das Wallet, das du verwendest. In diesem Beitrag erkläre ich dir, wie du dein Metamask Wallet mit verschiedenen Webseiten oder DApps verbindest.'
      },
      {
        subline: '1. Öffne die Webseite der DApp',
        text: 'Gehe zu der Webseite der DApp, mit der du dein Metamask Wallet verbinden möchtest. Eine Vielzahl von DApps existiert bereits, beispielsweise können diese für den Kauf und Verkauf von NFTs, den Handel mit Kryptowährungen oder die Teilnahme an DeFi-Anwendungen genutzt werden.',
        links: [
          {
            linkText: "TechMeDefi",
            href: "https://teachmedefi.de/"
      ...
      {
        subline: '2. Suche nach dem Connect Button',
        text: 'Auf den meisten Webseiten findest du normalerweise rechts oben einen "Connect"-Button. Wenn du darauf klickst, öffnet sich ein neues Fenster.',
      },
      {
        subline: '3. Wähle Metamask',
        text: 'In dem neuen Fenster kannst du Metamask als dein bevorzugtes Wallet auswählen.',
      },
      {
        subline: '4. Wähle das Konto, das du verbinden möchtest',
        text: 'Im nächsten Schritt wählst du das Konto aus, das du mit dieser Seite verknüpfen möchtest. Wenn du mehrere Konten in deinem Metamask Wallet hast, achte darauf, dass du das richtige auswählst.',
      },
      {
        subline: '5. Überprüfe die Berechtigungen',
        text: 'Du erhältst eine Übersicht darüber, welche Berechtigungen du der Seite gewährst. Achte darauf, dass du verstehst, welche Informationen du teilst und welche Aktionen die DApp in deinem Namen durchführen kann.',
      },
      {
        subline: 'Wichtig: Vermeide Scams und betrügerische Anfragen, indem du immer sicherstellst, dass die Seite vertrauenswürdig ist, bevor du sie mit deinem Wallet verbindest.',
      },
      {
        subline: '6. Verbinde dein Wallet',
        text: 'Klicke auf "Verbinden", um dein Wallet mit der Webseite zu verknüpfen. Nun bist du bereit, die DApp zu nutzen! Hast du das alles erledigt, kannst du deine erste Belohnung beanspruchen oder eine Transaktion einleiten. Herzlichen Glückwunsch! Du bist jetzt bereit, das volle Potenzial von DApps zu nutzen. ',
      },
      {
        text: 'Besuche Metamask für weitere Informationen und Ressourcen.',
        links: [
          {
            linkText: "MetaMask",
            href: "https://metamask.io/"
      ...
      {
        subline: 'Disclaimer: Denke daran, dass du immer verantwortungsbewusst und sicher handeln solltest, wenn du mit Kryptowährungen und DApps interagierst. Die Blockchain-Welt ist aufregend, kann aber auch riskant sein, wenn man sich nicht der Sicherheitsbestimmungen bewusst ist.',
      },
    ]
  }
]
