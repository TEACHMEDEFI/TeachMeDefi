...
export const ethLessons: Lesson[] = [
  ...
  //EVERY THING BELOW IS FOR TEST, DELETE BEFOR ADDING REAL VIDEOS FOR SECTION 2
  
  {
    id: "eth-test-1",
    title: 'Dezentrale Applikationen (dApps). test-1',
    slug: 'dezentrale-applikationen',
    youtubeUrl: 'https://www.youtube.com/watch?v=2VHPOGq0qfw',
    youtubeThumbnail: "https://img.youtube.com/vi/2VHPOGq0qfw/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-2",
    title: 'DeFi - Dezentrale Finanzsysteme. test-2',
    slug: 'dezentrale-finanzsysteme',
    youtubeUrl: 'https://www.youtube.com/watch?v=QD2RCTvh97o',
    youtubeThumbnail: "https://img.youtube.com/vi/QD2RCTvh97o/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-3",
    title: 'Die Tokenisierung von Vermögenswerten & Rechten - ERC20 & ERC721. test-3',
    slug: 'erc20-and-erc721',
    youtubeUrl: 'https://www.youtube.com/watch?v=3ng1K8eEfnU',
    youtubeThumbnail: "https://img.youtube.com/vi/3ng1K8eEfnU/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-4",
    title: 'Smart Contracts & Ethereum Virtual Mashine (EVM). PART 1',
    slug: 'ether-treibstoff-von-ethereum',
    youtubeUrl: 'https://www.youtube.com/watch?v=QgCqAEi7bsA',
    youtubeThumbnail: "https://img.youtube.com/vi/QgCqAEi7bsA/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-5",
    title: 'Smart Contracts & Ethereum Virtual Mashine (EVM). PART 2',
    slug: 'ether-treibstoff-von-ethereum',
    youtubeUrl: 'https://www.youtube.com/watch?v=QgCqAEi7bsA',
    youtubeThumbnail: "https://img.youtube.com/vi/QgCqAEi7bsA/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-6",
    title: 'Smart Contracts & Ethereum Virtual Mashine (EVM). PART 3',
    slug: 'ether-treibstoff-von-ethereum',
    youtubeUrl: 'https://www.youtube.com/watch?v=QgCqAEi7bsA',
    youtubeThumbnail: "https://img.youtube.com/vi/QgCqAEi7bsA/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-7",
    title: 'Irgendwas MetaMask. test-7',
    slug: 'ether-treibstoff-von-ethereum',
    youtubeUrl: 'https://www.youtube.com/watch?v=QgCqAEi7bsA',
    youtubeThumbnail: "https://img.youtube.com/vi/QgCqAEi7bsA/hqdefault.jpg",
    // importantLinks: [],
  ...
  {
    id: "eth-test-8",
    title: 'Talisman und Trustwallet. test-8',
    slug: 'ether-treibstoff-von-ethereum',
    youtubeUrl: 'https://www.youtube.com/watch?v=QgCqAEi7bsA',
    youtubeThumbnail: "https://img.youtube.com/vi/QgCqAEi7bsA/hqdefault.jpg",
    // importantLinks: [],
