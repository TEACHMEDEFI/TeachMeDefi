...
export default function Podcast() {
  return (
    <section id='podcast' className='pb-10 flex flex-col items-center px-5' >
      <div className=' bg-slate-100 dark:bg-gray-800 flex flex-col-reverse md:flex-row max-md:w-full items-center justify-between rounded-lg xl:w-[1240px] relative'>
