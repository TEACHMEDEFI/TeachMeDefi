    ...
    <section className='flex flex-col justify-center items-center w-full relative py-24 lg:py-44 px-5' >
      <div className="flex gap-10 xl:gap-28 flex-col xl:flex-row">
        <div className=" max-xl:flex max-lg:flex-col justify-center  items-center gap-10 lg:gap-24  ">
          <div>
            <h2 className="text-4xl  font-bold mb-6">Dein Tor zur Krypto-Welt!<br className="max-lg:hidden" /></h2>
          ...
          <div className=" w-full lg:w-[600px] relative flex flex-col justify-end max-xl:mt-5" >
