                ...
                {nftBalance > 0 && isConnected && 
                    ...
                    {!nftMinted && !nftMintable && isConnected && selectedPolkaAccount && questSectionId !== 'dot-quest-3' ? (
                        <>
                            ...
                            <h3>Bei Fragen oder Problemen sind wir gerne für dich da (nähere Infos findest du unten rechts auf der Webseite). Auf gehts, dein NFT wartet schon auf dich!</h3>
                        </>): null
                    }
