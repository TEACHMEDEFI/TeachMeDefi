          ...
          <Accordion allowToggle className='border-y-2 w-full' >
            <AccordionItem className="border-y-2 py-4" >
              ...
              <AccordionPanel pb={4}>
                ...
                <h2 className='pb-5'>Unsere Third-Party Cookies setzen sich zusammen aus den Anbietern:
                  <span className='flex flex-wrap  gap-1.5'>

                    <Link onClick={toggleModal} data-linktarget="faq-section" href={"/third-party-cookies"}
